...
class VendingMachine:
    ...
    def restock(self,cnt):
        self.cnt += cnt 
        return f'Current {self.category} stock: {self.cnt}'
...
class Coin:
    ...
    def worth(self):
        year = Mint.present_year - self.year
        return self.cents + (0 if(year <= 50) else year - 50 )
...
class VirFib():
    ...
    def next(self):
        value = self.pri_value + self.value
        answer =  VirFib(value)
        answer.pri_value = self.value
        return answer
...
def is_bst(t):
    ...
    if(t.is_leaf()):
        ...
        l,r = t.branches
        return is_bst(l) and is_bst(r) and bst_max(l) <= t.label and bst_min(r) > t.label
    else:
        return False
