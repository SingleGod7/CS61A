...
def picky_piggy(score):
    ...
    if(score == 0):
        ...
        if n == 0:
            n += 6
        return 758241 //(10 ** (n - 1)) - 758241 // (10 ** n) * 10 
    # END PROBLEM 2
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def print_highest(score0,score1): 
        if(who == 1):
            ...
            score = score0
        now = score - last_score
        if(running_high < now):
                print(now,"point(s)! That's a record gain for Player "+str(who)+"!")
                return announce_highest(who,score,now)
...
def picky_piggy_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    score1 = picky_piggy(opponent_score)
    if(score1 >= cutoff):
        return 0
    else:
        return num_rolls
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    score1 = picky_piggy(opponent_score)
    if(score + score1 == opponent_score):
        return 0
    else:
